...
horizontal displacement of deformable plate boundaries (Stephan et al., 2023). It is based on empirical
...
Next, we need to specify coordinates of the Pole of Rotation (PoR) to get the directions of 
...
NUVEL-1A model (DeMets et al. 1990) are included in the package and can be imported 
through:
